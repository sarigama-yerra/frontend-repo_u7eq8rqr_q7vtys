      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <div className="mt-6 inline-flex items-center text-indigo-700 font-medium">Explore Analysis →</div>
          </motion.a>
          ...
          >
            ...
            <div className="mt-6 inline-flex items-center text-amber-700 font-medium">Explore Calling →</div>
          </motion.a>
        </div>
      </div>
    </section>
